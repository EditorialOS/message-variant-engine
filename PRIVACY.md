...
Message Variant Engine is built privacy-first. There is no "us" to send your data to.

## What we collect

**Nothing.** Message Variant Engine has no backend server, no accounts, no analytics, and no telemetry.
